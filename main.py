...
pokemon_attributes = tk.Label(window)
pokemon_attributes.config(font=("Arial", 10))
pokemon_attributes.pack(padx=10, pady=10)
...
def load_pokemon():
    ...
    pokemon_attributes.config(text=f"{pokemon.base_stats}")
